...
- **`bot.ps1 know`** — wiki-backed lookups (joker, boss, tag, stake, deck, challenge, planet, tarot, voucher, spectral, rules); **`know preflight`** prints a phase-aware verified-facts table at blind/skip
