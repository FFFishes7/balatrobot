"""One-off: find RED/WHITE seed with Double Tag (small) + Charm Tag (big) on ante 1.

Record the result in tests/lua/tag_seeds.py as DOUBLE_THEN_CHARM.

    python scripts/find_double_charm_seed.py
"""
